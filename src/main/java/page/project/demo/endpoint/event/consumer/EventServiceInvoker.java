package page.project.demo.endpoint.event.consumer;
...
import page.project.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("page.project.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "page.project.demo.service.event."
