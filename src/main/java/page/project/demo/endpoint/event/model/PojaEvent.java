...
import static page.project.demo.endpoint.event.EventStack.EVENT_STACK_1;
...
import page.project.demo.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "page.project.demo.event1";
  }
}
